...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "cdd3bbe5e1608f7573459d9b82146a79";
    ...
    public void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.d("Clima", "onLocationChanged:location is changed ");
            ...
            public void onProviderDisabled(String provider) {
                Log.d("Clima", "onProviderDisabled:the location provider is disabled ");
    ...
    public void letsDoSomeNetworking(RequestParams params){
        ...
        client.get(WEATHER_URL,params,new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Log.e("Clima", "onFailure: Fail"+ errorResponse.toString());
